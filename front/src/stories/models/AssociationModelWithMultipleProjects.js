...
const secondProject = {
   ...
   needs: {
      ...
      material: {
         isNeeded: true,
         description: 'Deux chaises, une table, un ordinateur, un écran',
      },
      people: {
         isNeeded: false,
         description: null,
...
const AssociationModelWithMultipleProjects = {
   presentation: {
      name: 'Association 1',
...
export default AssociationModelWithMultipleProjects
